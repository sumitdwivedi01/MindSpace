...
const HomeNav = () => {
  ...
  return (
    <nav className="px-6 py-4 bg-cyan-50 shadow-md rounded-lg lg:mx-32 my-5">
      <div className="text-shadow-md text-xl flex justify-center space-x-12">
        ...
        <Link to="/music" className={`text-gray-700 hover:text-gray-400 transition ${isActive('/music')}`}>Relax-Music</Link>
